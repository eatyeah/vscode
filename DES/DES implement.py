...
DECRYPT_TEXT_FILE = "decryptedText.txt" #解密文件
...
if __name__ == "__main__":  
    ...
    PlainTextFile = open(PLAIN_TEXT_FILE, 'r', encoding='utf-8')
    CipherTextFile = open(CIPHER_TEXT_FILE, 'w', encoding='utf-8')
    DecryptedTextFile = open(DECRYPT_TEXT_FILE, 'w', encoding='utf-8')
    while True:
        ...
        if len(text_8_bytes) != 8:
            ...
            # 解密结果写入文件 
            DecryptedTextFile.write(str(ToAsciiChar(decryptStr)))
